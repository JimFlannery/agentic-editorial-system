        ...
        <form ref={formRef} action={handleSubmit} className="space-y-4 pt-2">
          ...
          {!isEdit && (
            <div className="space-y-1.5">
              <Label htmlFor="field_key">
                ...
                <span className="ml-1 font-normal text-muted-foreground">(machine name, no spaces)</span>
              </Label>
              <Input
                id="field_key"
                name="field_key"
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              className="w-full rounded-lg border border-input bg-card px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-zinc-900 dark:focus:ring-zinc-100 resize-none"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <select
                ...
                className="w-full rounded-lg border border-input bg-card px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-zinc-900 dark:focus:ring-zinc-100"
              >
                {FIELD_TYPES.map((t) => (
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex items-center gap-4 pt-2">
                {[
                  ...
                  <label key={opt.value} className="flex items-center gap-1.5 text-sm text-foreground cursor-pointer">
                    <input
                      type="radio"
                      name="required"
                      value={opt.value}
          ...
          {fieldType === "select" && (
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                className="w-full rounded-lg border border-input bg-card px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-zinc-900 dark:focus:ring-zinc-100 font-mono resize-none"
              />
            </div>
          )}
