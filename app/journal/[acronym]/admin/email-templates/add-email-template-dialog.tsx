...
export function AddEmailTemplateDialog({ acronym, template }: Props) {
  ...
  async function handleSubmit(formData: FormData) {
    ...
    try {
      if (isEdit) {
        await editEmailTemplate(acronym, template!.id, formData)
      } else {
        await addEmailTemplate(acronym, formData)
