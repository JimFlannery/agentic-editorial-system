...
export default function ChecklistPanel({ manuscriptId, journalId, initialChecklist }: Props) {
    ...
    <div>
        ...
        {items.map((item, idx) => (
          ...
          >
            ...
            <div className="shrink-0 flex items-center gap-2">
              ...
              {/* Override dropdown — only shown after AI evaluation */}
              {checklist && (
                <select
      ...
      <div className="border-t border-zinc-100 dark:border-zinc-800 pt-5">
        ...
        <div className="flex flex-wrap gap-3">
          <form action={passToEic.bind(null, manuscriptId, journalId)}>
            <button
              type="submit"
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-6 w-full max-w-md shadow-xl">
            ...
            <div className="flex gap-3 justify-end">
              ...
              <button
                onClick={() => {
                  startTransition(() => unsubmitManuscript(manuscriptId, journalId, unsubmitReason))
                }}
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 p-6 w-full max-w-md shadow-xl">
            ...
            <div className="flex gap-3 justify-end">
              ...
              <button
                onClick={() => {
                  startTransition(() => rejectWithTransfer(manuscriptId, journalId, transferTarget))
                }}
                disabled={isPending}
