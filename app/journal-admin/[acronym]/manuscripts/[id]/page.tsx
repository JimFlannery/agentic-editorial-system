  ...
  return (
    <div>
      ...
      <nav className="flex items-center gap-2 text-xs text-zinc-400 mb-6">
        <Link href={`/journal-admin/${acronym}`} className="hover:text-zinc-600 dark:hover:text-zinc-300">Journal Admin</Link>
        <span>/</span>
        <Link href={`/journal-admin/${acronym}/queue`} className="hover:text-zinc-600 dark:hover:text-zinc-300">Checklist Queue</Link>
        <span>/</span>
